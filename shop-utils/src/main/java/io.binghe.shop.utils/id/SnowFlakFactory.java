...
public class SnowFlakFactory {
    ...
    public static SnowFlake getSnowFlakeFromCache() {
        ...
        if (snowFlake == null) {
            snowFlake = new SnowFlake(DEFAULT_DATACENTER_ID,
                    DEFAULT_MACHINE_ID);
     ...
     */
    public static SnowFlake getSnowFlakeByDataCenterIdAndMachineIdFromCache(Long
                                                                                    dataCenterId, Long machineId) {
